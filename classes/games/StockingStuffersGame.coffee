...
class exports.StockingStuffersGame extends SlotGame
	pickBandits: null
	pickBags: null
	pickSecsAdded: 0
	...
	spin: ($state, $request)->
		...
		if operationTime > operationLimit then console.warn "WARNING -StockingStuffersGame: Respin took more than " + operationLimit + "ms. Operation took " + operationTime + "ms over " + i + " spins"
