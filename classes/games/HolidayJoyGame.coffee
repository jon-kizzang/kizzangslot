...
class exports.HolidayJoyGame extends SlotGame
	fsSpinsTotal: 0
	fsMxTotal: 0
	fsSecsAdded: 0
	...
	spin: ($state, $request)->
		...
		if operationTime > operationLimit then console.warn "WARNING -HolidayJoyGame: Respin took more than " + operationLimit + "ms. Operation took " + operationTime + "ms over " + i + " spins"
