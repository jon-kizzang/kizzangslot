...
class exports.GummiBarGame extends SlotGame
	maxBonusGameHits: 0
	...
	spin: ($state, $request)->
		...
		if operationTime > operationLimit then console.warn "WARNING -GummiBarGame: Respin took more than " + operationLimit + "ms. Operation took " + operationTime + "ms over " + i + " spins"
