/*
	Testing for the Holiday Joy game
*/
...
/** Slot games **/
var HolidayJoyGame = require("../classes/games/HolidayJoyGame").HolidayJoyGame;

/** Settings Variables **/
var numberOfSpins = 1000;
var totalSeconds = 300;
var totalSpins = 35;
var xmlFileName = "./xml/math/holidayjoy.xml";
...
function findXML(){
	describe("Find XML", function(){
		it("Game XML titled 'holidayjoy.xml' should be found in './xml/math'", function(done){
...
function loadGame(){
	describe("Load Game", function(){
		it ("Game XML should contain the id 'holidayjoy'", function(){

			xmlData.$.id.should.equal("holidayjoy");
		});
