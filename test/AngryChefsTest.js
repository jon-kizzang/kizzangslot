/*
	Testing for the Angry Chef's game
*/
...
/** Slot games **/
var AngryChefsGame = require("../classes/games/AngryChefsGame").AngryChefsGame;

/** Settings Variables **/
var numberOfSpins = 1000;
var totalSeconds = 300;
var totalSpins = 35;
var xmlFileName = "./xml/math/angrychefs.xml";
...
function findXML(){
	describe("Find XML", function(){
		it("Game XML titled 'angrychefs.xml' should be found in './xml/math'", function(done){
...
function loadGame(){
	describe("Load Game", function(){
		it ("Game XML should contain the id 'angrychefs'", function(){

			xmlData.$.id.should.equal("angrychefs");
		});
			...
			while (spins < numberOfSpins) {
				...
				while (spinsRemaining > 0)
				{
					...
					if (spinState.secsTotal > totalTime) {
						...
						if (!spinState.bonusPick) throw new Error("Time increased without a Pick Bonus!");
