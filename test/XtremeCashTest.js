/*
	Testing for the Xtreme Cash Explosion game
*/
...
var totalSpins = 35;
var fsMaxSpins = 30;
var xmlFileName = "./xml/math/xtremecash.xml";
...
function findXML(){
	describe("Find XML", function(){
		it("Game XML titled 'xtremecash.xml' should be found in './xml/math'", function(done){
...
function loadGame(){
	describe("Load Game", function(){
		it ("Game XML should contain the id 'xtremecash'", function(){

			xmlData.$.id.should.equal("xtremecash");
		});
