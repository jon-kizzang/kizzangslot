/*
	Testing for the Monkey Madness game
*/
...
var totalSpins = 35;
var fsMaxSpins = 30;
var xmlFileName = "./xml/math/monkeymadness.xml";
...
function run(){
	...
	describe("MonkeyMadness", function(){
...
function findXML(){
	describe("Find XML", function(){
		it("Game XML titled 'monkeymadness.xml' should be found in './xml/math'", function(done){
...
function loadGame(){
	describe("Load Game", function(){
		it ("Game XML should contain the id 'monkeymadness'", function(){

			xmlData.$.id.should.equal("monkeymadness");
		});
