/*
	Testing for the Diamond Streak
*/
...
var totalSpins = 26;
var fsMaxSpins = 30;
var xmlFileName = "./xml/math/diamondstreak.xml";
...
function run(){
	...
	describe("Diamond Streak", function(){
...
function findXML(){
	describe("Find XML", function(){
		it("Game XML titled 'diamondstreak.xml' should be found in './xml/math'", function(done){
...
function loadGame(){
	describe("Load Game", function(){
		it ("Game XML should contain the id 'diamondstreak'", function(){

			xmlData.$.id.should.equal("diamondstreak");
		});
