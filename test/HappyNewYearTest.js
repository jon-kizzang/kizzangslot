/*
	Testing for the Happy New Year game
*/
...
/** Slot games **/
var HappyNewYearGame = require("../classes/games/HappyNewYearGame").HappyNewYearGame;
...
var totalSpins = 35;
var fsMaxSpins = 30;
var xmlFileName = "./xml/math/happynewyear.xml";
...
function run(){
	...
	describe("HappyNewYear", function(){
...
function findXML(){
	describe("Find XML", function(){
		it("Game XML titled 'happynewyear.xml' should be found in './xml/math'", function(done){
...
function loadGame(){
	describe("Load Game", function(){
		it ("Game XML should contain the id 'happynewyear'", function(){

			xmlData.$.id.should.equal("happynewyear");
		});
