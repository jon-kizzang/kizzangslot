/*
	Testing for the Puppy Cash game
*/
...
var totalSpins = 26;
var xmlFileName = "./xml/math/puppycash.xml";
...
function findXML(){
	describe("Find XML", function(){
		it("Game XML titled 'puppycash.xml' should be found in './xml/math'", function(done){
...
function loadGame(){
	describe("Load Game", function(){
		it ("Game XML should contain the id 'puppycash'", function(){

			xmlData.$.id.should.equal("puppycash");
		});
