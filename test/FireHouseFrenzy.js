/*
	Testing for the Fire House Frenzy game
*/
...
var totalSpins = 35;
var fsMaxSpins = 30;
var xmlFileName = "./xml/math/firehousefrenzy.xml";
...
function run(){
	...
	describe("FireHouseFrenzy", function(){
...
function findXML(){
	describe("Find XML", function(){
		it("Game XML titled 'firehousefrenzy.xml' should be found in './xml/math'", function(done){
...
function loadGame(){
	describe("Load Game", function(){
		it ("Game XML should contain the id 'firehousefrenzy'", function(){

			xmlData.$.id.should.equal("firehousefrenzy");
		});
