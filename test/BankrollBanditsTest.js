/*
	Testing for the Bankroll Bandits game
*/
...
/** Slot games **/
var BankrollBanditsGame = require("../classes/games/BankrollBanditsGame").BankrollBanditsGame;
...
var totalSpins = 35;
var fsMaxSpins = 30;
var xmlFileName = "./xml/math/bankrollbandits.xml";
...
function run(){
	...
	describe("BankrollBandits", function(){
...
function findXML(){
	describe("Find XML", function(){
		it("Game XML titled 'bankrollbandits.xml' should be found in './xml/math'", function(done){
...
function loadGame(){
	describe("Load Game", function(){
		it ("Game XML should contain the id 'bankrollbandits'", function(){

			xmlData.$.id.should.equal("bankrollbandits");
		});
