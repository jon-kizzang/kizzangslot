/*
	Testing for the Crusaders Quest game
*/
...
/** Slot games **/
var CrusadersQuestGame = require("../classes/games/CrusadersQuestGame").CrusadersQuestGame;
...
var totalSpins = 35;
var fsMaxSpins = 30;
var xmlFileName = "./xml/math/crusadersquest.xml";
...
function run(){
	...
	describe("CrusadersQuest", function(){
...
function findXML(){
	describe("Find XML", function(){
		it("Game XML titled 'crusadersquest.xml' should be found in './xml/math'", function(done){
...
function loadGame(){
	describe("Load Game", function(){
		it ("Game XML should contain the id 'crusadersquest'", function(){

			xmlData.$.id.should.equal("crusadersquest");
		});
