...
var totalSpins = 26;
var fsMaxSpins = 30;
var xmlFileName = "./xml/math/aprilmadness.xml";
...
function run(){
	...
	describe("AprilMadness", function(){
...
function loadGame(){
	describe("Load Game", function(){
		it ("Game XML should contain the id 'aprilmadness'", function(){

			xmlData.$.id.should.equal("aprilmadness");
		});
