...
/** Slot games **/
var ButterflyTreasuresGame = require("../classes/games/ButterflyTreasuresGame").ButterflyTreasuresGame;
...
var totalSpins = 35;
var fsMaxSpins = 30;
var xmlFileName = "./xml/math/butterflytreasures.xml";
...
function run(){
	...
	describe("ButterflyTreasures", function(){
...
function findXML(){
	describe("Find XML", function(){
		it("Game XML titled 'butterflytreasures.xml' should be found in './xml/math'", function(done){
...
function loadGame(){
	describe("Load Game", function(){
		it ("Game XML should contain the id 'butterflytreasures'", function(){

			xmlData.$.id.should.equal("butterflytreasures");
		});
